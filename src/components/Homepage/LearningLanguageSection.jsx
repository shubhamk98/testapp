...
const LearningLanguageSection = () => {
  return (
   ...
   <>  
      <div className='text-3xl md:text-4xl font-semibold text-center my-10'>
            ...
            <p className="text-center text-richblack-700 font-medium lg:w-[75%] mx-auto leading-6 text-sm  md:text-base mt-3"> Using spin making learning multiple languages easy. with 20+ languages realistic voice-over, progress tracking, custom schedule and more. </p>
